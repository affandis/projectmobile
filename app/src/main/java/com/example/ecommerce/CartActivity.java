...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        final DatabaseReference historyListRef = FirebaseDatabase.getInstance().getReference();

        FirebaseRecyclerOptions<Cart> options =
                new FirebaseRecyclerOptions.Builder<Cart>()
                .setQuery(cartListRef.child(Prevalent.currentOnlineUser.getUsername())
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (which == 1){
                                    cartListRef.child(Prevalent.currentOnlineUser.getUsername())
                                            .child("Products")
                                            .child(model.getPid())
                                            .removeValue()
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        txtTotalAmount.setText("Dear" + name + "\n order is shipped successfully");
                        recyclerView.setVisibility(View.GONE);

                        txtMsg1.setVisibility(View.VISIBLE);
                        txtMsg1.setText("Congratulations, your final order has been placed successfully. Soon you will received your order at your door step. Soon it will be verified");
